...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void onShare(String url) async {
    try {
      await Share.share('Check out this link: $url');
    } catch (e) {
      print(e.toString());
      showDialog(
        context: context,
          ...
          builder: (context, state) {
            if (state.status == AuthenticationStatus.unauthenticated) {
              ...
              scaffoldMessenger.showSnackBar(const SnackBar(
                  ...
                  content:
                      Text('Please Log in or create account to View Product')));
              ...
              child: BlocBuilder<GetProductBloc, GetProductState>(
                builder: (context, state) {
                  if (state is GetProductLoading) {
                    ...
                    List<Color> productColor = product.color
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  IconButton(
                                                    onPressed: () {
                                                      onShare(
                                                        'https://leonclassycollection.netlify.app/#/details/${product.productId}',
                                                      );
                                                    },
                                                    icon:
                                                            ...
                                                            (index) => Padding(
                                                              ...
                                                              child:
                                                                ...
                                                                child:
                                                                  ...
                                                                  decoration:
                                                                      BoxDecoration(
                                                                          borderRadius: BorderRadius.circular(selectedColor == index
                                                                              ? 12.5
                                                                              : 15),
                                                                ...
                                                                onPressed: () {
                                                                  product.stock >
                                                                      ...
                                                                      ? setState(
                                                                          () {
                                                                          final myUserBloc =
                                                                              context.read<MyUserBloc>();
                                                                          if (myUserBloc.state.user !=
                                                                              null) {
                                                                            if (myUser.cartProducts ==
                                                                                null) {
                                                                              myUser = myUser.copyWith(cartProducts: []);
                                                                            }
                                                                            var newSize =
                                                                                List<String>.from(product.size);
                                                                            newSize.add(selectedSize.toString());
                                                                            var newColor =
                                                                                List<String>.from(product.color);
                                                                            newColor.add(selectedColor.toString());
                                                                            var productToAdd =
                                                                                Product(
                                                                              createdAt: product.createdAt,
                                                                              productId: product.productId,
                                                                              name: product.name,
                                                                              description: product.ageGroup,
                                                                              price: product.price,
                                                                            ...
                                                                            var existingProductIndex = myUser.cartProducts!.indexWhere((cartProduct) =>
                                                                            ...
                                                                            if (existingProductIndex !=
                                                                              ...
                                                                              myUser.cartProducts![existingProductIndex]['quantity'] += 1;
                                                                            } else {
                                                                              // If the product doesn't exist, add it to the cart with a quantity of 1
                                                                              var productToAddEntity = productToAdd.toEntity().toDocument();
                                                                              productToAddEntity['quantity'] = 1;
                                                                              myUser = myUser.copyWith(
                                                                                cartProducts: myUser.cartProducts!..add(productToAddEntity),
                                                                              );
                                                                            }

                                                                            context.read<UpdateUserInfoBloc>().add(UpdateUserInfoRequired(myUser));
                                                                          }
                                                                        })
                                                                      : null;
                                                                },
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      height: selectedColor ==
                                                                          ...
                                                                          : 30,
                                                                      decoration: BoxDecoration(
                                                                          borderRadius: BorderRadius.circular(selectedColor == index ? 12.5 : 15),
                                                                          color: selectedColor == index ? Colors.white : productColor[index],
                                                                          border: Border.all(
                                                                            width:
                                                                                2,
                                                                            color:
                                                          ...
                                                          builder:
                                                            ...
                                                            return StreamBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  var myUser = MyUser.fromEntity(MyUserEntity.fromDocument(snapshot
                                                                          .data!
                                                                          .data()
                                                                      as Map<
                                                                          String,
                                                                      ...
                                                                      setState(
                                                                        ...
                                                                        if (myUserBloc.state.user !=
                                                                          ...
                                                                          var newSize =
                                                                              List<String>.from(product.size);
                                                                          newSize
                                                                              .add(selectedSize.toString());
                                                                          var newColor =
                                                                              List<String>.from(product.color);
                                                                          newColor
                                                                              .add(selectedColor.toString());
                                                                          var productToAdd =
                                                                              Product(
                                                                            createdAt:
                                                                                product.createdAt,
                                                                          ...
                                                                          if (existingProductIndex !=
                                                                              -1) {
                                                                            // If the product exists, increment its quantity
                                                                            myUser.cartProducts![existingProductIndex]['quantity'] +=
                                                                                1;
                                                                          } else {
                                                                            // If the product doesn't exist, add it to the cart with a quantity of 1
                                                                            var productToAddEntity =
                                                                                productToAdd.toEntity().toDocument();
                                                                            productToAddEntity['quantity'] =
                                                                                1;
                                                                            myUser =
                                                                                myUser.copyWith(
                                                                              cartProducts: myUser.cartProducts!..add(productToAddEntity),
